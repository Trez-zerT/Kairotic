const langs = {
  ...
  da: {
    ...
    toast_entry_added: 'Opgave tilfojet',
    ...
    reports_monthly: 'Maanedlige totaler',
    reports_yearly: 'Arlige totaler',
    reports_newer: 'nyere',
    reports_older: 'aldre',
    reports_goal_prefix: 'Mal',

    settings_disable_goals: 'Deaktiver mal',
    settings_weekly_target: 'Ugentligt mal (timer)',
    settings_yearly_target: 'Arligt mal (timer)',
    settings_vacation_days: 'Feriedage',
    settings_show_daily: 'Vis daglig',
    settings_show_weekly: 'Vis ugentlig',
    settings_show_monthly: 'Vis manedlig',
    settings_show_yearly: 'Vis arlig',
    settings_theme: 'Tema',
    settings_theme_system: 'System',
    settings_theme_light: 'Lys',
    settings_theme_dark: 'Mork',
    settings_data: 'Data',
    settings_export_csv: 'Eksporter CSV',
    settings_export_json: 'Eksporter JSON (Backup)',
    ...
    install_banner: 'Foj til Hjemmeskarm for hurtig adgang',
